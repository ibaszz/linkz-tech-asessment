export const Love = (props: { color: string; className: string }) => {
  return (
    <svg
      fill={props.color}
      height="800px"
    ...
    >
      <g>
        <g>
          <path
            d="M477.051,72.678c-32.427-36.693-71.68-55.467-111.787-55.467c-45.227,0-85.333,27.307-109.227,72.533
